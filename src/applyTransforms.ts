 ...
 */
export default (polyline: any[], transforms: any[]) => {
  transforms.forEach((transform: { scaleX: number; scaleY: number; rotation: number; x: any; y: any; extrusionZ: number }) => {
    polyline = polyline.map(function (p: any[]) {
