...
export const process = (tuples: any[]) => {
  return tuples.reduce(
    (entity: { block: any; x: any; y: any; z: any; scaleX: any; scaleY: any; scaleZ: any; columnSpacing: any; rowSpacing: any; rotation: any; columnCount: any; rowCount: any; extrusionX: any; extrusionY: any; extrusionZ: any }, tuple: any[]) => {
      const type = tuple[0]
      const value = tuple[1]
      switch (type) {
        case 2:
