...
export const process = (tuples: any[]) => {
  return tuples.reduce(
    (entity: { block: any; start: { x: any; y: any; z: any }; textMidpoint: { x: any; y: any; z: any }; measureStart: { x: any; y: any; z: any }; measureEnd: { x: any; y: any; z: any }; rotation: any; horizonRotation: any; extensionRotation: any; textRotation: any; ordinateType: boolean; uniqueBlockReference: boolean; userDefinedLocation: boolean; dimensionType: any; attachementPoint: any; extrudeDirection: { x?: any; y?: any; z?: any } }, tuple: any[]) => {
      const type = tuple[0]
      const value = tuple[1]
      switch (type) {
        case 2:
 ...
 */
function parseBitCombinationsFromValue(value: number) {
