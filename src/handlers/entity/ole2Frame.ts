...
export const process = (tuples: any[]) => {
  return tuples.reduce(
    (entity: { version: any; name: any; upperLeftX: any; upperLeftY: any; upperLeftZ: any; lowerRightX: any; lowerRightY: any; lowerRightZ: any; objectType: any; tile: any; length: any; data: any }, tuple: any[]) => {
      const type = tuple[0]
      const value = tuple[1]
      switch (type) {
        case 70:
