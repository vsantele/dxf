...
export const process = (tuples: any[]) => {
  ...
  return tuples.reduce(
    (entity: { controlPoints: { x: any; y: number }[]; knots: any[]; weights: any[]; knotTolerance: any; controlPointTolerance: any; fitTolerance: any; flag: any; closed: boolean; degree: any; numberOfKnots: any; numberOfControlPoints: any; numberOfFitPoints: any }, tuple: any[]) => {
      const type = tuple[0]
      const value = tuple[1]
      switch (type) {
        case 10:
